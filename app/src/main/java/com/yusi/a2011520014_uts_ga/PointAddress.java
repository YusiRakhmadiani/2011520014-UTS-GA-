 ...
 */
package com.yusi.a2011520014_uts_ga;
 ...
 */
class PointAddress extends AsyncTask<Location, Void, String> {

    private Context mContext;
    private OnTaskCompleted mListener;


    PointAddress(Context applicationContext, OnTaskCompleted listener) {
        mContext = applicationContext;
        mListener = listener;
    }

    private final String TAG = PointAddress.class.getSimpleName();
